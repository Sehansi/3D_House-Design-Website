...
import { Heart, Ruler, Palette, Calendar, PenTool, CheckCircle, Rocket, Share2 } from 'lucide-react';
...
function Gallery() {
  ...
  return (
    <div className="gallery-container">
      ...
      <div className="gallery-hero" style={{ background: "url('/images/gallery_hero_bg.png') center/cover no-repeat fixed" }}>
        <div className="gallery-header-content">
          <h1>Design Vault</h1>
          <p>Explore world-class 3D architectural renders curated by top experts</p>
        </div>
      </div>
        ...
        {filteredDesigns.map(design => (
          <div key={design.id} className="gallery-item">
            <div className="gallery-image-container">
              ...
              >
                <Heart fill={isFavorite(design.id) ? '#ff0050' : 'transparent'} color={isFavorite(design.id) ? '#ff0050' : 'white'} size={20} />
              </button>
              ...
              <div className="modal-left">
                ...
                <div className="modal-quick-info">
                  <div className="quick-info-item">
                    <Ruler className="info-icon" color="#00d9ff" size={24} />
                    <div>
                  ...
                  <div className="quick-info-item">
                    <Palette className="info-icon" color="#a78bfa" size={24} />
                    <div>
                  ...
                  <div className="quick-info-item">
                    <Calendar className="info-icon" color="#00d9ff" size={24} />
                    <div>
                  ...
                  <div className="quick-info-item">
                    <PenTool className="info-icon" color="#a78bfa" size={24} />
                    <div>
                ...
                <div className="detail-section">
                  ...
                  <ul className="features-list">
                    {selectedDesign.details.features.map((feature, index) => (
                      <li key={index}>
                        <CheckCircle className="feature-icon" color="#00d9ff" size={18} />
                        {feature}
                      </li>
                    ))}
                  </ul>
